...
public class UploadImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("application/json;charset=UTF-8");
        ...
        try {
            ...
            String directories = "/opt/apache-tomcat-9.0.12/webapps/ROOT/upload/" + username + "/" + id;
            ...
            MultipartRequest m = new MultipartRequest(request, "/opt/apache-tomcat-9.0.12/webapps/ROOT/upload/" + username + "/" + id);
    ...
    protected void getImage(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File folder = new File("/opt/apache-tomcat-9.0.12/webapps/ROOT/upload/" + username + "\\" + id);
